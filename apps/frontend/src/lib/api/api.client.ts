...
export const backendUrl = `${PUBLIC_BACKEND_PROTOCOL}://${PUBLIC_BACKEND_HOST}:${PUBLIC_BACKEND_PORT}`;
export const backendHost = `${PUBLIC_BACKEND_HOST}:${PUBLIC_BACKEND_PORT}`;
