...
export function settingsTerminalFooterExpandedGet(): boolean {
	return state.terminalFooterExpanded;
}

export function settingsTerminalFooterExpandedSet(value: boolean): void {
	state.terminalFooterExpanded = value;
	settingsSave(state);
}
